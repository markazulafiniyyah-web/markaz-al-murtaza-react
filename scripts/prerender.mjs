...
const pages={
 ...
 terms:{title:`Terms, Policies & Key Terminology | ${BRAND}`,description:'Read the terms of use, learning-service policies, privacy expectations, donation guidance and key Quran-education terminology.',keywords:'terms of service, Quran classes policy, privacy policy, donation policy, Quran terminology'},
