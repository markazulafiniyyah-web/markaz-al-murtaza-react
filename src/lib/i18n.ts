...
en: { name:"English", en:"English", flag:"🌍", region:"Worldwide", rtl:false, t:{
  ...
  visual_kicker:"Our Learning Home", visual_title:"A place shaped around the Qur'an.", visual_sub:"3D architectural visualizations developed from photographs of the institute’s real building and its distinctive arched design.", visual_tag:"Architectural visualization", visual1_title:"Rooted in a real learning space", visual1_desc:"A purpose-built identity for focused Qur'an education and personal guidance.", visual2_title:"An entrance to lifelong learning", visual2_desc:"A welcoming environment representing discipline, care and steady progress.", visual3_title:"Tradition carried beyond walls", visual3_desc:"From a physical home of learning to one-to-one Hifz, Nazra and Tajweed classes online.",
